  ...
  return payload.periods
    .map((period) => {
      ...
      return {
        ...
        total,
        // Keep sealed source rows intact; presentation-specific ordering is applied separately.
...
export function sortHistoricalRegionsBySettlementRate(regions) {
  return [...regions].sort((left, right) =>
    left.settlementRate - right.settlementRate
    || right.unsettledCount - left.unsettledCount
