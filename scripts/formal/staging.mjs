...
if (offlineBundleMode && process.env.OFFLINE_BUNDLE_VERIFIED !== "YES") {
  throw new Error("STAGING_RELEASE_BLOCKED: OFFLINE_BUNDLE_VERIFIED=YES is required for OFFLINE_EXACT_GIT_HANDOFF_APPROVED=YES");
}
